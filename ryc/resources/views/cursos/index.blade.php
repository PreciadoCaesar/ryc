...
<div class="admin-container">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <div>
            <a href="{{ route('cursos.formulario') }}" class="btn btn-primary" style="background: #FF044D; border: none; padding: 10px 20px; border-radius: 8px;">
                ...
                <tbody>
                    ...
                    <tr>
                        <td colspan="7" class="text-center py-4">
                            ...
                            <a href="{{ route('cursos.formulario') }}" class="btn btn-primary mt-3" style="background: #FF044D; border: none;">
                                Crear primer curso
                            </a>
                        </td>
                    </tr>
