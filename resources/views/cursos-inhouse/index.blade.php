...
<link href="{{ asset('cursos-inhouse/styles.css') }}" rel="stylesheet">
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css">
<link rel="icon" href="{{ asset('cursos-inhouse/img/logo-rc-consulting-icono.ico') }}" sizes="32x32">
@endsection
        ...
        <div class="contenido-banner-purpura">
            <div class="banner-item">
                <div class="banner-icon">
                    <img src="{{ asset('cursos-inhouse/img/icons/casa.svg') }}" alt="PDP">
                </div>
            ...
            <div class="banner-item">
                <div class="banner-icon">
                    <img src="{{ asset('cursos-inhouse/img/icons/merito.svg') }}" alt="Directiva">
                </div>
                <div class="banner-text">
...
<nav class="navbar navbar-expand-lg rc-navbar">
    <div class="container" style="background-color: white;">
        ...
        <a class="navbar-brand" href="{{ url('/') }}">
            <img src="{{ asset('cursos-inhouse/img/logo-rc-consulting-sin-fondo.webp') }}" class="rc-logo" alt="R&C Consulting">
        </a>
        ...
        <div class="collapse navbar-collapse" id="mainNav">
            ...
            <ul class="navbar-nav mx-auto w-100 justify-content-evenly">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('cursos-inhouse') }}">In House</a>
                </li>
            </ul>
        ...
        <div class="row align-items-center g-0">
            ...
            <div class="col-lg-6">
                <div class="hero-pdp__img-full">
                    <img src="{{ asset('cursos-inhouse/img/pdp_2026.png') }}" alt="Capacitación PDP 2026">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="container">
        ...
        <div class="alerta-grid">
            <div class="alerta-card">
                <img src="{{ asset('cursos-inhouse/img/icons/seccion1/1.svg') }}" alt="Riesgo de incumplimiento de plazos">
            </div>
            <div class="alerta-card">
                <img src="{{ asset('cursos-inhouse/img/icons/seccion1/2.svg') }}" alt="Incremento de brechas de falta de capacidades">
            </div>
            <div class="alerta-card">
                <img src="{{ asset('cursos-inhouse/img/icons/seccion1/3.svg') }}" alt="Bajo desempeño de los servidores civiles">
            </div>
        </div>
    ...
    <div class="container">
        ...
        <div class="sumate-stats">
            <div class="sumate-stat-card">
                <div class="stat-icon">
                    <img src="{{ asset('cursos-inhouse/img/icons/seccion2/1.svg') }}" alt="Icono Gobierno">
                </div>
            ...
            <div class="sumate-stat-card">
                <div class="stat-icon">
                    <img src="{{ asset('cursos-inhouse/img/icons/seccion2/2.svg') }}" alt="Icono TDR">
                </div>
                <div class="stat-content">
            ...
            <div class="sumate-stat-card">
                <div class="stat-icon">
                    <img src="{{ asset('cursos-inhouse/img/icons/seccion2/3.svg') }}" alt="Icono SEACE">
                </div>
                <div class="stat-content">
        ...
        <div class="carousel-outer-pdp">
            <div class="carousel-track-pdp" id="carouselTrackPdp">
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 54@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 55@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 56@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 57@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 58@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 59@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 60@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 61@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 62@4x.webp') }}" alt="Entidad"></div>
                <div class="carousel-card-pdp"><img src="{{ asset('cursos-inhouse/img/Logo de entidades/Recurso 64@4x.webp') }}" alt="Entidad"></div>
    ...
    <div class="container">
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-lg-4 col-md-6">
                <div class="porque-pdp-card">
                    <div class="pdp-card__icon">
                        <img src="{{ asset('cursos-inhouse/img/icons/seccion2/1.svg') }}" alt="Experiencia">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="porque-pdp-card">
                    <div class="pdp-card__icon">
                        <img src="{{ asset('cursos-inhouse/img/icons/seccion2/2.svg') }}" alt="Certificación">
                    </div>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="porque-pdp-card">
                    <div class="pdp-card__icon">
                        <img src="{{ asset('cursos-inhouse/img/icons/seccion2/3.svg') }}" alt="Programas">
                    </div>
...
<section class="experiencia-banner">
    <div class="exp-container">
        <div class="exp-image">
            <img src="{{ asset('cursos-inhouse/img/consultores.png') }}" alt="Consultores R&C">
        </div>
            ...
            <div class="exp-inner-padding">
                ...
                <div class="exp-action">
                    <a href="https://apps.osce.gob.pe/perfilprov-ui/ficha/20506331014/contratos?pageNumber=1"
                        ...
                        <img src="{{ asset('cursos-inhouse/img/icons/experienciaIcono.svg') }}" class="form-icon">
        ...
        <div class="servicios-grid">
            <div class="servicio-card">
                <div class="s-icon-wrap">
                    <img src="{{ asset('cursos-inhouse/img/icons/servicios/PunteroFlecha.svg') }}" alt="Planificación">
                </div>
            ...
            <div class="servicio-card">
                <div class="s-icon-wrap">
                    <img src="{{ asset('cursos-inhouse/img/icons/servicios/Engranaje.svg') }}" alt="Ejecución">
                </div>
            ...
            <div class="servicio-card">
                <div class="s-icon-wrap">
                    <img src="{{ asset('cursos-inhouse/img/icons/servicios/Persona.svg') }}" alt="Asesoría">
                </div>
    ...
    <div class="inner-wrap">
        ...
        <div class="asesor-card">
            <div class="asesor-img">
                <img src="{{ asset('cursos-inhouse/img/asesor.png') }}" alt="Arnaldo Montaño Rivera">
            </div>
    ...
    <div id="cotizar" class="form-container-wrap">
        <div class="inner-wrap form-flex">
            ...
            <div class="form-info">
                ...
                <p class="form-item">
                    <img src="{{ asset('cursos-inhouse/img/icons/check.svg') }}" class="form-icon">
                ...
                <form id="miFormulario" style="font-family: 'Poppins';">
                    ...
                    <div class="input-group input-with-icon">
                        ...
                        <div class="relative-container">
                            <img src="{{ asset('cursos-inhouse/img/icons/user.svg') }}" class="input-icon">
                    ...
                    <div class="input-group input-with-icon">
                        ...
                        <div class="relative-container">
                            <img src="{{ asset('cursos-inhouse/img/icons/carta.svg') }}" class="input-icon">
                    ...
                    <div class="input-group input-with-icon">
                        ...
                        <div class="relative-container">
                            <img src="{{ asset('cursos-inhouse/img/icons/carpeta.svg') }}" class="input-icon">
                    ...
                    <div class="input-group input-with-icon">
                        ...
                        <div class="relative-container">
                            <img src="{{ asset('cursos-inhouse/img/icons/celular.svg') }}" class="input-icon">
...
<footer>
    <div class="inner-wrap">
        <div class="row g-4">
            <div class="col-md-3">
                <img src="{{ asset('cursos-inhouse/img/added/logofooter.webp') }}" alt="R&C Consulting"
            ...
            <div class="col-md-3">
                ...
                <img src="{{ asset('cursos-inhouse/img/added/payment.webp') }}" alt="Métodos de pago" style="max-height:28px;">
            </div>
            <div class="col-md-3">
                <h3>Certificados</h3>
                <a href="{{ route('certificados') }}" class="btn-cert-f"><i class="fas fa-search"></i> Consulta tu certificado</a>
                <div style="display:flex;align-items:center;gap:8px;margin-bottom:14px;">
                    <img src="{{ asset('cursos-inhouse/img/added/lreclamaciones.svg') }}" alt="Libro de reclamaciones" style="height:32px;">
...
<script src="{{ asset('cursos-inhouse/js/jquery-3.2.1.min.js') }}"></script>
<script src="{{ asset('cursos-inhouse/js/added.js') }}"></script>
@endsection
