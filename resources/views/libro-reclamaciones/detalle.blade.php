...
@section('title', 'Detalle Reclamo ' . ($codigo ?? '') . ' | R&C Consulting')
...
@if ($error)
        <div class="error-box">
            ...
            <a href="{{ route('rc-gestor-reclamos') }}" class="btn btn-primary btn-lg mt-3">
                <i class="bi bi-arrow-left"></i> Volver al panel
            </a>
        </div>
@else
        <div class="d-flex justify-content-between align-items-center mb-4 no-print">
            <a href="{{ route('rc-gestor-reclamos') }}" class="btn btn-outline-secondary">
                <i class="bi bi-arrow-left"></i> Volver al panel
            </a>
            @php
                $docPdf = $reclamo['tipo_persona'] === 'natural' ? ($reclamo['doc_numero_natural'] ?? '') : ($reclamo['ruc_juridica'] ?? '');
            @endphp
            <a href="{{ route('libro-reclamaciones.pdf', ['codigo' => $codigo, 'documento' => $docPdf]) }}" class="btn btn-danger" target="_blank">
...
@endif
            ...
            <div class="result-card" id="archivos">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <li class="list-group-item d-flex align-items-center gap-3">
                        ...
                        <a href="{{ route('libro-reclamaciones.descargar', $a['id']) }}" target="_blank" class="text-decoration-none fw-medium">
                            {{ $a['nombre_original'] }}
                        </a>
                    </li>
                    @endforeach
        ...
        <div class="text-center mt-4 no-print d-flex justify-content-center gap-2">
            <a href="{{ route('libro-reclamaciones.pdf', ['codigo' => $codigo, 'documento' => $docPdf]) }}" class="btn btn-danger btn-lg" target="_blank">
                <i class="bi bi-file-pdf"></i> Descargar PDF
            </a>
            <a href="{{ route('rc-gestor-reclamos') }}" class="btn btn-outline-secondary btn-lg">
                <i class="bi bi-arrow-left"></i> Volver al panel
            </a>
        </div>
@endif
