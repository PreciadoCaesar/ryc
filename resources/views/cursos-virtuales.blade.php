...
@section('title', 'Cursos Online SIAF SIGA SEACE Perú 2026 | R&C Consulting')

@section('meta_description', 'Cursos online SIAF, SIGA, SEACE, Presupuesto Público y Contrataciones del Estado en Perú. Capacitación virtual con certificación oficial. ¡Inscríbete ahora!')
        ...
        <div class="curso-card__body">
            ...
            <div class="info-asinc-grid">
                <div class="info-asinc-item">
                    <img src="{{ asset('img/cursos-virtuales/iconos/calendario.webp') }}" alt="Calendario" class="icon-asinc-custom">
                    <div class="info-asinc-text">¡Inicia<br>ahora!</div>
                </div>
                <div class="info-asinc-item">
                    <img src="{{ asset('img/cursos-virtuales/iconos/tiempo.webp') }}" alt="Tiempo" class="icon-asinc-custom">
                    <div class="info-asinc-text">Duración:<br><span>{{ $curso->sessions ?? 12 }} sesiones</span></div>
                </div>
                <div class="info-asinc-item">
                    <img src="{{ asset('img/cursos-virtuales/iconos/online.webp') }}" alt="Online" class="icon-asinc-custom">
                    <div class="info-asinc-text"><span class="color-red">Modalidad<br>online</span></div>
                </div>
                <div class="info-asinc-item">
                    <img src="{{ asset('img/cursos-virtuales/iconos/certificado.webp') }}" alt="Certificado" class="icon-asinc-custom">
