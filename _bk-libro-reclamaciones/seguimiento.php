...
if ($codigo && $documento) {
    ...
    header('Location: buscar-reclamo.php');
    exit;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Seguimiento Reclamo <?= htmlspecialchars($codigo) ?> | R&C Consulting</title>
    ...
    <!-- Script removido: ahora se usa Dompdf del lado servidor -->
    <style>
...
<?php if ($error): ?>
            <div class="error-box">
                ...
                <a href="buscar-reclamo.php" class="btn btn-primary btn-lg mt-3">
...
<?php foreach ($archivos as $a): ?>
                        <li class="list-group-item d-flex align-items-center gap-3">
                            ...
                            <a href="<?= htmlspecialchars($a['ruta']) ?>" target="_blank" class="text-decoration-none">
...
<?php endif; ?>
            ...
            <div class="text-center mt-4 no-print d-flex justify-content-center gap-2">
                <a href="practica/generar_reclamo.php?codigo=<?= urlencode($codigo) ?>&documento=<?= urlencode($documento) ?>" class="btn btn-danger btn-pdf" target="_blank">
                    <i class="bi bi-file-pdf"></i> Descargar PDF
                </a>
                <a href="buscar-reclamo.php" class="btn btn-primary btn-pdf">
