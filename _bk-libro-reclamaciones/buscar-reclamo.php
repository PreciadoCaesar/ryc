...
<head>
    ...
    <title>Buscar Reclamo | R&C Consulting</title>
    ...
    <section class="search-section">
        <div class="container">
            <div class="search-card">
                ...
                <form action="seguimiento.php" method="GET" onsubmit="return validarBusqueda()">
                    <div class="mb-4">
                ...
                <div class="text-center mt-4 pt-3 border-top">
                    ...
                    <a href="index.php" class="btn btn-success btn-buscar">
                        Registrar Reclamo
                    </a>
                </div>
